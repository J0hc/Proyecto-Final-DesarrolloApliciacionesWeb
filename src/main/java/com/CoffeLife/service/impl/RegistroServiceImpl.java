...
import com.CoffeLife.service.RegistroService;
...
public class RegistroServiceImpl implements RegistroService {
    ...
    @Autowired
    private CorreoServices correoService;
    @Autowired
    ...
    public Model activar(Model model, String username, String clave) {
        Usuario usuario = 
                usuarioService.findByUsernameAndPassword(username, 
                        clave);
        if (usuario != null) {
    ...
    public Model recordarUsuario(Model model, Usuario usuario) 
            throws MessagingException {
        String mensaje;
        Usuario usuario2 = usuarioService.findByUsernameOrCorreo(
                usuario.getUsername(), 
                usuario.getCorreo());
        if (usuario2 != null) {
            String clave = demeClave();
    ...
    private void enviaCorreoActivar(Usuario usuario, String clave) throws MessagingException {
        ...
        String asunto = messageSource.getMessage(
                ...
                null, Locale.getDefault());
        System.out.println("Llamando a enviarCorreoHtml...");
